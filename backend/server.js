...
const listingsRoutes    = require('./src/modules/listings/listings.routes'); // ✅ AJOUTÉ

app.use("/api/users",        userRoutes);
app.use("/api/auth",         authRoutes);
app.use("/api/rentals",      rentalRoutes);
app.use("/api/appartements", appartementRoutes);
app.use("/api/annonces",     listingsRoutes);   // ✅ AJOUTÉ : GET /, GET /cities, GET /:id
app.use("/api/annonces",     feedbackRoutes);   // feedback en premier (ses routes POST)
