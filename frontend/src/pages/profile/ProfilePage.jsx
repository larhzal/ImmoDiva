...
const handleUpdatePassword = async () => {
  ...
  try {
    const res = await fetch(`${API}/update-password`, {  // ← changed endpoint
      method: "PUT",                                       // ← often PUT for updates
      headers: authHeaders({ "Content-Type": "application/json" }),
      body: JSON.stringify({
        currentPassword: pass.current,
        newPassword: pass.newPass,        // ← check what your backend expects
      }),
    });
    ...
    <div>
      ...
      <section className="section">
        ...
        <div className="infoGrid">
          ...
          <Field label="Âge :"          name="age"         value={info.age}         onChange={handleInfoChange} error={errors.age} min="18" type="number"/>
